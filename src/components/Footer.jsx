function Footer() {
    return (
        <div className="w-100  bg-dark text-light mt-5">
            <div className="row justify-content-center pt-5 pb-3 gap-lg-3 gap-5">
                <div className="col-lg-3">
                    <h3 className="fw-light">اللوجو</h3>
                    <h6 className="fw-light">شعارك هنا</h6>
                </div>
                <div className="col-lg-2">
                    <h6  className="fw-light">أضف محتوي هنا</h6>
                    <h6 className="fw-light">أضف محتوي هنا</h6>
                    <h6 className="fw-light">أضف محتوي هنا</h6>
                </div>
                <div className="col-lg-2">
            ...
            <div className="mt-4 line d-lg-block d-none "></div>
            ...
            <div className="copyright text-center mt-3">
                    <h6 className="fw-lighter">&copy;جميع حقوق النشر محفوظة</h6>
            </div>
        </div>
    );
}
